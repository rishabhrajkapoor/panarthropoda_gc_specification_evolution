...
mcmcfile = mcmc_prep_no_partitionrun2R.mcmctree.log  * MCMC log of parameters that can be examined in Tracer
outfile = mcmc_prep_no_partitionrun2R.mcmctree.out  * Output of the summerized results of MCMCtree
